...
ACLOCAL = ${SHELL} /mnt/project/resnap/build/trunk/missing --run aclocal-1.11
AMTAR = ${SHELL} /mnt/project/resnap/build/trunk/missing --run tar
AUTOCONF = ${SHELL} /mnt/project/resnap/build/trunk/missing --run autoconf
AUTOHEADER = ${SHELL} /mnt/project/resnap/build/trunk/missing --run autoheader
AUTOMAKE = ${SHELL} /mnt/project/resnap/build/trunk/missing --run automake-1.11
AWK = gawk
CYGPATH_W = echo
...
INSTALL_BASE_ARG = install_base=/tmp/hecht/snap2
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mnt/project/resnap/build/trunk/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = snap2
...
STRIP = 
VERSION = 1.0.0
abs_builddir = /mnt/project/resnap/build/trunk
abs_srcdir = /mnt/project/resnap/build/trunk
abs_top_builddir = /mnt/project/resnap/build/trunk
abs_top_srcdir = /mnt/project/resnap/build/trunk
am__leading_dot = .
...
install_sh = ${SHELL} /mnt/project/resnap/build/trunk/install-sh
